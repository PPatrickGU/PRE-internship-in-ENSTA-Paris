...
def transformData(input_folder, output_folder, time_gaps, episode_number, frame_interval):
...
if __name__ == '__main__':
    ...
    transformData(input_folder=args.InputFolder, output_folder=args.OutputFolder, time_gaps=args.TimeGaps, episode_number = args.EpisodeNumber, frame_interval = args.FrameIntervalParameter)
