#/blender/blender --background --python macro.py
import bpy
...
#this macro needs the file ocean_render2.blend
...
def load_handler(dummy):
	...
	#add a background
	#bpy.ops.object.load_background_image(filepath="./world_2.jpeg", filter_image=True, filter_folder=True, view_align=True)
	...
	bpy.ops.curve.primitive_bezier_circle_add(radius=1, enter_editmode=True, location=(0,0,0))
	bpy.context.view_layer.objects.active = bpy.data.objects['BezierCircle']

	bpy.ops.object.editmode_toggle()
	bpy.ops.transform.resize(value=(cir_x, cir_y, 1), constraint_axis=(False, False, False), orient_matrix_type='GLOBAL', mirror=False,use_proportional_edit=False, proportional_edit_falloff='SMOOTH', proportional_size=1)
	...
	bpy.ops.transform.translate(value=(0, 0, heigth), constraint_axis=(False, False, True), orient_matrix_type='GLOBAL', mirror=False, use_proportional_edit=False, proportional_edit_falloff='SMOOTH', proportional_size=1, release_confirm=True)
